...
<body>
 <div class="content">
    <div class="wrap">
      <section class="main">
        <h1>Starter Files Table of Content</h1>

        <h2>Templates</h2>
        <ul>
          <li><a href="general/">General Styles</a></li>
          <li><a href="home/">Home Page</a></li>
        </ul>

        <h2>Layouts</h2>
        <ul>
          <li><a href="layouts/layout-a.php">Layout A (one column)</a></li>
          <li><a href="layouts/layout-b.php">Layout B (two column)</a></li>
        </ul>
      </section>
    </div>
  </div>
